...
| [map_method](#geneinfo.plot.GenomeIdeogram.map_method) | Map a matplotib axes method like plot and scatter to each ideogram panel (axis). |
...
<code>[**x**]{.parameter-name} [:]{.parameter-annotation-sep} []{.parameter-annotation}</code>
