# get_go_terms_for_genes { #geneinfo.get_go_terms_for_genes }

```python
geneinfo.get_go_terms_for_genes(genes, taxid=9606, evidence=None)
```
...
<code>[**genes**]{.parameter-name} [:]{.parameter-annotation-sep} [[str](`str`)]{.parameter-annotation}</code>
