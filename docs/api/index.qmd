...
| [venn](venn.qmd#geneinfo.plot.venn) |  |

## Tracks widget

Widget for zooming/panning large chromosome tracks with gene annotation.


| | |
| --- | --- |
| [Tracks](Tracks.qmd#geneinfo.widget.Tracks) | WebGL2 genomic segment viewer rendered as a Jupyter widget. |
...
| | |
| --- | --- |
| [gene_coords](gene_coords.qmd#geneinfo.coords.gene_coords) | Get gene coordinates for a gene or list of genes. |
| [gene_coords_region](gene_coords_region.qmd#geneinfo.coords.gene_coords_region) | Gets gene structure information for genes in a chromosomal region. |
...
Thin wrapper for lists, adding methods and operator overloading.
